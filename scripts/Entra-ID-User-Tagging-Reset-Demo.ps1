<#
.SYNOPSIS
    Entra-ID-User-Tagging-Reset-Demo - engine script in the Entra-Policy-Suite solution.

.NOTES
    Solution       : Entra-Policy-Suite
    File           : Entra-ID-User-Tagging-Reset-Demo.ps1
...
#############################################################################################
    ...
    $Tag_Conditions = import-csv -Path "$($global:PathScripts)\DATA\Identity_Tagging_Demo_Reset.csv" -Delimiter ";" -Encoding UTF8
