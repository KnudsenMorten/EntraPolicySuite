<#
.SYNOPSIS
    Entra-ConditionalAccess-Management - engine script in the Entra-Policy-Suite solution.

.NOTES
    Solution       : Entra-Policy-Suite
    File           : Entra-ConditionalAccess-Management.ps1
...
$d(estinationFolder = $Path_CA_Scripts_Github_Latest_Inbound + "\TEMP"
