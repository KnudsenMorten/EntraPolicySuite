<#
.SYNOPSIS
    CA208 - engine script in the Entra-Policy-Suite solution.
...
########################################################################################################################################
# Policy Prefix         : CA208
# Policy Name           : CA208-Users-Internal-Office365-iOSAndroid-Unmanaged-RequireAppProtection
...
if ($Mode -eq "Initial_Setup") {
    ...
    EntraGroup -DisplayName "Entra-CA-CA208-Users-Internal-Office365-iOSAndroid-Unmanaged-RequireAppProtection-Excluded-Assigned" `
               -Description "Excluded Users for Policy CA208-Users-Internal-Office365-iOSAndroid-Unmanaged-RequireAppProtection" `
    ...
    if ($Group_Targeting_Method -eq "Dynamic_Using_Tags") {
        ...
        EntraGroup -DisplayName "Entra-CA-CA208-Users-Internal-Pilot-Dynamic" `
                   -Description "Pilot Users for Entra-CA-CA208-Users-Internal" `
                   -EntraGroupsHashTable $EntraGroupsHashTable `
                   -AutomaticMailNickName `
                   -MailEnabled $false `
                   -SecurityEnabled $true `
        ...
        $PolicyPilotGroup = $EntraGroupsHashTable["Entra-CA-CA208-Users-Internal-Pilot-Dynamic"]
    }
    elseif ($Group_Targeting_Method -eq "Manual_Assignment_Advanced") {
        foreach ($pilot in 1..3) {

            # Create pilot group, if missing
            EntraGroup -DisplayName "Entra-CA-CA208-Users-Internal-Pilot$pilot-Assigned" `
                       -Description "Pilot Users for Entra-CA-CA208-Users-Internal" `
                       -EntraGroupsHashTable $EntraGroupsHashTable `
                       -AutomaticMailNickName `
                       -MailEnabled $false `
        ...
        # Find group info in hash table
        $PolicyPilotGroup = $EntraGroupsHashTable["Entra-CA-CA208-Users-Internal-Pilot1-Assigned"]
    }
    ...
    # Find group info in hash table
    $PolicyExcludeGroup = $EntraGroupsHashTable["Entra-CA-CA208-Users-Internal-Office365-iOSAndroid-Unmanaged-RequireAppProtection-Excluded-Assigned"]

    # Configure initial policy - see policy documentation on https://github.com/KnudsenMorten/EntraPolicySuite
    EntraCAPolicy -CAPolicyPrefix "CA208-Initial" `
                  -DisplayName "CA208-Initial-Users-Internal-Office365-iOSAndroid-Unmanaged-RequireAppProtection" `
...
elseif ($Mode -eq "Pilot1") {
    ...
    elseif ($Group_Targeting_Method -eq "Manual_Assignment_Advanced") {
        ...
        # Create pilot target group, if missing
        EntraGroup -DisplayName "Entra-CA-CA208-Users-Internal-Pilot1-Assigned" `
                   -Description "Pilot Users for Entra-CA-CA208-Users-Internal" `
                   -EntraGroupsHashTable $EntraGroupsHashTable `
                   -AutomaticMailNickName `
                   -MailEnabled $false `
    ...
    EntraCAPolicy -CAPolicyPrefixArray @("CA208-Initial", "CA208-Pilot1", "CA208-Pilot2", "CA208-Pilot3", "CA208-Prod") `
                  -DisplayName "CA208-Pilot1-Users-Internal-Office365-iOSAndroid-Unmanaged-RequireAppProtection" `
                  -Cond_Users_IncludeUsers @() `
                  -Cond_Users_IncludeGroups @(($PolicyPilotGroup.id)) `
...
elseif ($Mode -eq "Pilot2") {
    ...
    elseif ($Group_Targeting_Method -eq "Manual_Assignment_Advanced") {
        ...
        # Create pilot target group, if missing
        EntraGroup -DisplayName "Entra-CA-CA208-Users-Internal-Pilot2-Assigned" `
                   -Description "Pilot Users for Entra-CA-CA208-Users-Internal" `
                   -EntraGroupsHashTable $EntraGroupsHashTable `
                   -AutomaticMailNickName `
                   -MailEnabled $false `
        ...
        # Find group info in hash table
        $PolicyPilotGroup = $EntraGroupsHashTable["Entra-CA-CA208-Users-Internal-Pilot2-Assigned"]
    }
    elseif ($Group_Targeting_Method -eq "Manual_Assignment_Simple") {
    ...
    EntraCAPolicy -CAPolicyPrefixArray @("CA208-Initial", "CA208-Pilot1", "CA208-Pilot2", "CA208-Pilot3", "CA208-Prod") `
                  -DisplayName "CA208-Pilot2-Users-Internal-Office365-iOSAndroid-Unmanaged-RequireAppProtection" `
                  -Cond_Users_IncludeUsers @() `
                  -Cond_Users_IncludeGroups @(($PolicyPilotGroup.id)) `
                  -State enabled `
                  -CreateUpdate
...
elseif ($Mode -eq "Pilot3") {
    ...
    elseif ($Group_Targeting_Method -eq "Manual_Assignment_Advanced") {
        ...
        # Create pilot target group, if missing
        EntraGroup -DisplayName "Entra-CA-CA208-Users-Internal-Pilot3-Assigned" `
                   -Description "Pilot Users for Entra-CA-CA208-Users-Internal" `
                   -EntraGroupsHashTable $EntraGroupsHashTable `
                   -AutomaticMailNickName `
                   -MailEnabled $false `
        ...
        # Find group info in hash table
        $PolicyPilotGroup = $EntraGroupsHashTable["Entra-CA-CA208-Users-Internal-Pilot3-Assigned"]
    ...
    EntraCAPolicy -CAPolicyPrefixArray @("CA208-Initial", "CA208-Pilot1", "CA208-Pilot2", "CA208-Pilot3", "CA208-Prod") `
                  -DisplayName "CA208-Pilot3-Users-Internal-Office365-iOSAndroid-Unmanaged-RequireAppProtection" `
                  -Cond_Users_IncludeUsers @() `
                  -Cond_Users_IncludeGroups @(($PolicyPilotGroup.id)) `
                  -CreateUpdate
}
...
elseif ($Mode -eq "Prod") {
    ...
    if ($Group_Targeting_Method -eq "Dynamic_Using_Tags") {
        ...
        EntraGroup -DisplayName "Entra-CA-CA208-Users-Internal-Pilot-Dynamic" -GroupType DynamicMembership -MembershipRuleProcessingState Paused -ForceUpdate
    }
    ...
    EntraCAPolicy -CAPolicyPrefixArray @("CA208-Initial", "CA208-Pilot1", "CA208-Pilot2", "CA208-Pilot3", "CA208-Prod") `
                  -DisplayName "CA208-Prod-Users-Internal-Office365-iOSAndroid-Unmanaged-RequireAppProtection" `
                  -Cond_Users_IncludeUsers @() `
...
elseif ($Mode -eq "Install_Latest_Policy_Disabled") {
    ...
    EntraCAPolicy -CAPolicyPrefix "CA208-$($PolicyVersion)" `
                  -DisplayName "CA208-$($PolicyVersion)-Users-Internal-Office365-iOSAndroid-Unmanaged-RequireAppProtection" `
                  -Cond_Users_IncludeUsers @() `
                  -Cond_Users_IncludeGroups @(($PolicyPilotGroup.id)) `
                  -Cond_Users_ExcludeGroups @(($BreakGlassAccountsGroup.id), ($PolicyExcludeGroup.id)) `
                  -Cond_Users_ExcludeUsers @(($BreakGlassAccounts.id)) `
...
elseif ($Mode -eq "Update_Prod_Policy_To_Latest") {
    ...
    EntraCAPolicy -CAPolicyPrefix "CA208-Prod" `
                  -GC_Operator "OR" `
                  -GC_BuiltInControls "compliantApplication" `
                  -CreateUpdate
