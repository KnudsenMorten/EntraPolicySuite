<#
.SYNOPSIS
    EntraPolicySuite - engine script in the Entra-Policy-Suite solution.

.NOTES
    Solution       : Entra-Policy-Suite
    File           : EntraPolicySuite.psm1
...
# Example usage:
# EntraUser -DisplayName "John Doe" -UserPrincipalName "john.doe@domain.com" -GivenName "John" -Surname "Doe" -JobTitle "Developer" -Department "Engineering" -MobilePhone "123-456-7890" -OfficeLocation "Building 1" -Create
# EntraUser -DisplayName "John Doe" -UserPrincipalName "john.doe@domain.com" -GivenName "John" -Surname "Doe" -JobTitle "Developer" -Department "Engineering" -MobilePhone "123-456-7890" -OfficeLocation "Building 1" -ForceUpdate
